...
src/content/
  index.mdx
  features/      intro, installing, publishing, auditing, local-linking, private-packages, ci, models, studios (+ studios/members, studios/permissions), mirrored-packages, ai-agents   (one overview page per feature, badged per platform, links into the deep docs)
