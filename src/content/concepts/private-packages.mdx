...
- Any member or role that has been granted access to that specific package. See [Roles & Package Permissions](/features/studios/permissions) for how grants work.
