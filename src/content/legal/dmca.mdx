...
## Notice, Takedown, and Putback Process
    ...
    If a proper counter-notification is received, Forest Software forwards it to the original complainant within a reasonable time (typically 1 to 2 business days).

    ##### Put-Back Window (10 to 14 Business Days)
