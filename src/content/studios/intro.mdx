...
- **Free Studios** are limited to **5 members** (including the owner), include up to **10 [private packages](/concepts/private-packages)**, keep **7 days** of audit log history, and share one "new package every 12 hours" cooldown across all their publishers (publishing new *versions* of existing packages is never rate-limited).
