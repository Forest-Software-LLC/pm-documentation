...
- **Team access control.** [Ranks](/features/studios/members), [roles, and per-package permissions](/features/studios/permissions) control who can see private packages and who can manage the Studio.
...
Publishing a **new** package under a Studio requires the **admin or owner rank**. Members can publish new versions of an **existing** package if they hold a `write` [permission grant](/features/studios/permissions) on it.
...
- **Members** additionally see the private packages they hold a [permission grant](/features/studios/permissions) for.
