...
Suppose your project needs three packages: `forest/pasta`, `user1/sauce`, and `user1/meatballs`. Install each with `forest install` (alias `forest i`; every flag is covered in the [CLI reference](/forest-cli/commands#forest-install)):
